  ...
  return function k(b, c, e) {
    function r(n) {
      ...
      var a = ("base64" == a[2] ? atob : decodeURIComponent)(a.pop()),
        ...
        d = 0,
        c = new Uint8Array(b);
      for (d; d < b; ++d) c[d] = a.charCodeAt(d);
      return new g([c], { type: n });
    }
    function l(a, b) {
      if ("download" in d)
        return (
    ...
    "true" === String(this) && ((b = [b, a]), (a = b[0]), (b = b[1]));
    if (
      e &&
      2048 > e.length &&
      ((m = e.split("/").pop().split("?")[0]),
      (d.href = e),
      -1 !== d.href.indexOf(e))
    )
      return (
    ...
    c = b instanceof g ? b : new g([b], { type: a });
    if (navigator.msSaveBlob) return navigator.msSaveBlob(c, m);
    if (f.URL) l(f.URL.createObjectURL(c), !0);
    else {
